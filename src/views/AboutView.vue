...
<template>
  <div
    class="min-h-screen-minus-80 pattern flex flex-col gap-3 md:gap-5 p-3 md:p-5 text-center items-center justify-center h-full bg-radial from-main-100 to-main-200"
  >
    <div>
